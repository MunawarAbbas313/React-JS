...
function Login({ onLogin, isSignup, SetHead }) {
    ...
    // Refs for email, password, and name
    ...
    function HandleLogin(e) {
        e.preventDefault();
        if (Loginvalidatio()) {
            const email = emailref.current.value;  // Get email for setting user context
            setUserEmail(email);  // Set email in UserContext
                    ...
                    <div className="rightside">
                        ...
                        {isSignup ? (
                            ...
                            <form className="loginForm">
                                ...
                                <Link className="linkkk" to="/signup">
                                    Don't have an Account{" "}
                                    <span className="san">Register</span>
                                </Link>
                            </form>
                        )}
                    </div>
